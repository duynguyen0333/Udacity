...
from dags.sql_container.sql_statements import SqlQueries

start_date = datetime(2023, 7, 1)
end_date = datetime(2023, 7, 30)

s3_bucket = "duy-airflow-bucket"
...
def final_airflow_project():
    ...
    create_redshift_tables = PostgresOperator(
        ...
        sql='sql_container/sql_statements.py'
    )
...
final_project_dag = final_airflow_project()